...
const AboutUs = () => {
  return (
    <main>
      ...
      <div className="container flex flex-col items-center justify-center mx-auto pt-14 ">
        <h3
          className={`${abhaya.className} text-3xl lg:text-6xl font-bold leading-[76px] tracking-[-5%] text-[#292019] text-center`}
        >
          About Us
        </h3>
        <p className="md:max-w-[600px] pt-7 text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-10">
          <div className="items-center gap-8 pt-16 lg:flex">
            <Image
