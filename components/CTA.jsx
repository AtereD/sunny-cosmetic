  ...
  return (
    <section className='w-full h-full'>
        <div className='container p-0 mx-auto'>
            <div className='w-full h-[280px] bg-[#7ccde1] rounded-xl md:relative p-7 flex items-center'>
                ...
                <div className='md:absolute left-[80%]'>
                    <Image src={"/assets/cta-mockup-img.png"} width={109} height={348} alt="cta-product-image" className='w-[100px] md:w-[109px]'/>
                </div>
